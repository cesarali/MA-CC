...
Ported near-verbatim from `src/naming_game/analysis/estimators.py` (the
legacy committee-empowerment pipeline) - this module is pure NumPy with no
coupling to any particular game's schema, so the port is exact.
"""

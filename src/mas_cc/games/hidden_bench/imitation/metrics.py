...
METRICS = [
    ...
    _SummaryMetric("delta_H_vote"),
    _SummaryMetric("focal_changed"),
    _SummaryMetric("focal_adopted_target"),
    _SummaryMetric("focal_left_target"),
    _SummaryMetric("u_advocate"),
    _SummaryMetric("sensor_target_share"),
    _SummaryMetric("population_target_share"),
    _SummaryMetric("sensor_target_error"),
    _SummaryMetric("sensor_target_abs_error"),

...
- Experiment: `relational-study01-d-adversarial-diagnostic-overnight`; game `relational_imitation_round_feedback`; provider `university` / `gwdg/openai-gpt-oss-120b`.
...
- Preflight ID: `a2637e24062e1e26bb9890a45a0300615e2723b2ec96ea431df086342b08893a` — pass this to `mas-cc experiment run --approve-preflight` to bind the launch to this estimate.

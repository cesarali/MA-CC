...
- Experiment: `relational-study01-b-social-control-overnight`; game `relational_imitation_round_feedback`; provider `university` / `gwdg/openai-gpt-oss-120b`.
...
- Preflight ID: `02574397433dbeeeb50e5a0de32101ad31b7044a59c184eb4f7d5778db5230e8` — pass this to `mas-cc experiment run --approve-preflight` to bind the launch to this estimate.
